...
export class KidsEffects {
  ...
  loadAll$: Observable<Action> = this.actions$.pipe(
    ...
    switchMap(() => this.kidResource.getKids()),
  ...
  load$: Observable<Action> = this.actions$.pipe(
    ...
    switchMap((id) => this.kidResource.getKidById(id)),
  ...
  create$: Observable<Action> = this.actions$.pipe(
    ...
    switchMap((kid) => this.kidResource.createKid(kid)),
  ...
  patch$: Observable<Action> = this.actions$.pipe(
    ...
    switchMap((kid: KidModel) => this.kidResource.updateKid(kid)),
  ...
  destroy$: Observable<Action> = this.actions$.pipe(
    ...
    switchMap(kid => this.kidResource.deleteKid(kid).pipe(
